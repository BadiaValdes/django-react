                    ...
                    {props.data.map((row) => (
                        ...
                        >
                            ...
                            <TableCell component="td" scope="row" align="center">
                                <Box>
                                    <Button onClick={() => props.editFunction(row['id'])}>Edit</Button>
                                    {props.seeFunction && <Button onClick={() => props.seeFunction(row['id'])}>See</Button>}
                                    <Button onClick={() => props.deleteFunction(row['id'])}>Delete</Button>
                                </Box>
                            </TableCell>
                        </TableRow>
                    ))}
